...
def main():
    ...
    load_enemy_sprites()     # ladda fiende-sprites FÖRE reset
    load_all_animations()    # ladda Luna-sprites FÖRE reset
    reset(1)                 # reset EFTER sprites är laddade
